...
bool entretien::Ajouter()
{
  ...
  QString idoffre= QString ::number(ID_offre);
     query.prepare("insert into ENTRETIEN(ID_RDV,DATE_RDV,TYPE_RDV,CIN_AB,ID_O,NOM_C) values(ENTRETIEN_SEQ.nextval, :DateE , :Type, :CIN_A, :ID_offre, :NOM_C)");
...
>>>>>>> d3dc43c6ce113ff5d61d94d07e1b01b1a4f581d4:Recruiting_Help_Center/entretien.cpp
}
