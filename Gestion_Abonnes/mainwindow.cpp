...
void MainWindow::on_pushButton_Entrer_clicked()
{
    QSqlQuery query ;
...
void MainWindow::on_pushButton_changerPoste_clicked()
{
...
void MainWindow::on_pushButton_AnullerAjout_clicked()
{
    ui->lineEdit_CIN->setText("");
    ui->lineEdit_TEL->setText("") ;
    ui->lineEdit_AGE->setText("") ;
...
void MainWindow::on_pushButton_AnnulerSupp_clicked()
{
     ui->lineEdit_CIN_Suprrimer->setText("");
}


void MainWindow::on_pushButton_AnnulerModifier_clicked()
{
    ui->lineEdit_CIN_update->setText("");
    ui->lineEdit_TEL_update->setText("") ;
    ui->lineEdit_AGE_updtae->setText("") ;
...
void MainWindow::on_pushButton_IMPRIME_clicked()
{
    QString strStream;
